...
def predict():
    ...
    return render_template('index.html',prediction_texts=str(output))
    return output
    if output <1:
        return render_template('index.html',prediction_texts="Sorry , he has no more")
    else:
        return render_template('index.html',prediction_text='this person is servived{}'.format(output))
...
# for_chek_record=[pclass,age_of_passenger,sibsp,parch,female,male,embark_C,embark_Q,embark_S,town_c,town_q,town_s]
# print(for_chek_record)
